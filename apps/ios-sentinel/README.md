...
The iOS sentinel is a client of the wire protocol defined in
...
1. Generate an Ed25519 keypair at registration and keep the private half in the
   Secure Enclave. `Curve25519.Signing.PrivateKey()`; send
   `.publicKey.rawRepresentation` base64-encoded, 32 bytes.
...
4. Heartbeat every 15 minutes. This is the most important thing it does — the
