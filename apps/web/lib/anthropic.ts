...
export const DRAFTING_MODEL = process.env.ANTHROPIC_MODEL_DRAFTING ?? "claude-sonnet-5";

/** Weekly questions and pattern notes — short, frequent, routine. */
export const ROUTINE_MODEL = process.env.ANTHROPIC_MODEL_ROUTINE ?? "claude-haiku-4-5-20251001";
